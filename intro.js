...
const codeObj = require('./sol') ;

const loginLink = 'https://www.hackerrank.com/auth/login' ;
const email = 'Baka.Boi.899@gmail.com' ;
const password = 'Baka@123' ;
...
browserOpen.then(function( browserObj ){
    ...
    // check this
    let allChallengesCountPromise = page.$$(`.ui-btn.ui-btn-normal.primary-cta.ui-btn-line-primary.ui-btn-styled` , {delay : 50}) ;
    return allChallengesCountPromise ;
